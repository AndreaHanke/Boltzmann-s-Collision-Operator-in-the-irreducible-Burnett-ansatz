...
void testCasenumberInit(int*** &resVec, int ** &alln2s, int ** &nCombs){
    for (int n=0; n<NNmax+1; n++){
//        cout << n << "\n";
        for (int n1=0; n1<NNmax+1 -(n+NNmax)%2; n1++){
//            cout << "\t" << n1 << "\n";
            for (int idxn2 = 0; idxn2 < nCombs[n][n1]; idxn2++){
                if (resVec[n][n1][idxn2] <0){
                    cout << "\n!!!!!!!!!!!!!!!!!!!!!!!!!! \n uninitialized casenumber at n=" << n << ", n1=" << n1 << ", idxn2=" << idxn2 << ",\t n2=" << alln2s[n][n1] +2*idxn2 << "\t" << resVec[n][n1][idxn2] << "\n!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n";
                    return;
                }
                
//                cout << "\t\t" << idxn2 << "\t" << alln2s[n][n1] +2*idxn2 << "\t" << resVec[n][n1][idxn2] << "\n";
            }
        }
//        cout << "\n---------------------------------------------------\n";
    }
...
//Collect old code which I probably won't need anymore...
// void cppCasenumbers(){
//     int *** combinations;
//     int ** n2mins;
//     int ** nCombs;
//     
//     cout << "Hello, World!\n";
//     cout << "Building Combinations-Vector\n";
//     buildCombVec(combinations, n2mins, nCombs);
//     cout << "Done\n";
//     
//     cout << "Initializing Combinations-Vector\n";
//     initializeCaseNumbers(combinations, n2mins);
//     cout << "Done\n";
//     
//     cout << "Testing Combinations-Vector initialization\n";
// //   cout << combinations[5][5][0];
//     testCasenumberInit(combinations, n2mins, nCombs);
//     cout << "Done\n";
// 
//     
//     
//     cout << "Freeing Combinations-Vector\n";
//     freeCombinations(combinations, n2mins, nCombs);
//     cout << "Done\n";
//     
//     cout << "Goodboy\n";
//     
